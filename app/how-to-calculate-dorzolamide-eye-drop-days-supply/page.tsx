...
export const metadata: Metadata = {
  title: "How to Calculate Dorzolamide Eye Drop Days Supply | Pharmacist Guide",
  description:
    "Step-by-step pharmacist guide explaining how to calculate dorzolamide eye drop days supply using bottle size, drops per mL, dosing frequency, and practical workflow considerations.",
  keywords: [
    "dorzolamide eye drop days supply",
    "how to calculate dorzolamide eye drop days supply",
    "dorzolamide ophthalmic days supply",
    "dorzolamide day supply",
    "eye drop days supply calculator dorzolamide",
    "dorzolamide eye drops pharmacist guide",
  ],
  alternates: {
    canonical:
  ...
  openGraph: {
    title:
      "How to Calculate Dorzolamide Eye Drop Days Supply | Pharmacist Guide",
    description:
      "Step-by-step pharmacist guide explaining how to calculate dorzolamide eye drop days supply using bottle size, drops per mL, dosing frequency, and practical workflow considerations.",
    url: "https://www.insulinprimingdayssupply.com/how-to-calculate-dorzolamide-eye-drop-days-supply",
...
const faqs = [
  {
    question: "How do you calculate dorzolamide eye drop days supply?",
    answer:
  ...
  {
    question: "How many drops are in a 10 mL dorzolamide bottle?",
    answer:
  ...
  {
    question: "Why can dorzolamide eye drop days supply vary?",
    answer:
  ...
  {
    question: "Why is dorzolamide days supply important for billing?",
    answer:
...
export default function HowToCalculateDorzolamideEyeDropDaysSupplyPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": ["MedicalWebPage", "FAQPage"],
    name: "How to Calculate Dorzolamide Eye Drop Days Supply",
    url: "https://www.insulinprimingdayssupply.com/how-to-calculate-dorzolamide-eye-drop-days-supply",
    description:
      "Step-by-step guide for calculating dorzolamide eye drop days supply using bottle size, drops per mL, and dosing frequency.",
    audience: {
    ...
    relatedLink: [
      ...
      "https://www.insulinprimingdayssupply.com/eye-drops-ndc-reference/dorzolamide",
    ...
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-700">
          ...
          <strong>dorzolamide eye drop days supply</strong> using bottle size,
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            href="/eye-drops-ndc-reference/dorzolamide"
            className="inline-flex items-center rounded-xl border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
          >
            Dorzolamide NDC Page
          </Link>
        </div>
      </section>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Step-by-step: how to calculate dorzolamide eye drop days supply
        </h2>
        ...
        <div className="mt-6 space-y-6 text-slate-700">
          <div>
            ...
            <p className="mt-2 leading-7">
              Review the exact dorzolamide product and bottle size dispensed.
              Common ophthalmic bottles may vary, so the exact package should
              always be confirmed before estimating days supply.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 leading-7">
              ...
              Dorzolamide is often dosed more than once daily.
            </p>
          </div>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Example dorzolamide eye drop days supply calculation
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Common dorzolamide eye drop days supply mistakes
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          >
            <h3 className="text-lg font-semibold text-slate-900">
              Dorzolamide Eye Drops NDC Reference
            </h3>
            <p className="mt-2 text-slate-700">
              Package NDCs, brands, and labelers for dorzolamide ophthalmic
              products.
            </p>
          </Link>
      ...
      <section className="mt-10 rounded-3xl border border-cyan-100 bg-cyan-50 p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Frequently asked questions about dorzolamide eye drop days supply
        </h2>
