...
export const metadata: Metadata = {
  title: "Ofloxacin Ear Drops Days Supply | Pharmacist Guide",
  description:
    "Step-by-step pharmacist guide explaining how to calculate ofloxacin ear drops days supply using bottle size, drops per mL, dosing frequency, one ear or both ears, and practical workflow considerations.",
  keywords: [
    "ofloxacin ear drops days supply",
    "ofloxacin days supply",
    "how to calculate ofloxacin ear drops days supply",
  ...
  openGraph: {
    title: "Ofloxacin Ear Drops Days Supply | Pharmacist Guide",
    description:
      "Step-by-step pharmacist guide explaining how to calculate ofloxacin ear drops days supply using bottle size, drops per mL, dosing frequency, and ear-specific directions.",
    url: "https://www.insulinprimingdayssupply.com/ofloxacin-ear-drops-days-supply",
...
const faqs = [
  {
    question: "How do you calculate ofloxacin ear drops days supply?",
    answer:
  ...
  {
    question: "Why can ofloxacin ear drops days supply vary?",
    answer:
...
export default function OfloxacinEarDropsDaysSupplyPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": ["MedicalWebPage", "FAQPage"],
    name: "Ofloxacin Ear Drops Days Supply",
    url: "https://www.insulinprimingdayssupply.com/ofloxacin-ear-drops-days-supply",
    description:
      "Step-by-step guide for calculating ofloxacin ear drops days supply using bottle size, drops per mL, dosing frequency, and ear-specific directions.",
    audience: {
    ...
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-700">
          ...
          <strong>ofloxacin ear drops days supply</strong> using bottle size,
          estimated drops per mL, dosing frequency, one-ear or both-ears
          directions, and treatment duration.
        </p>

        <p className="mt-2 text-sm text-slate-600">
          This ofloxacin ear drops days supply calculator helps pharmacists
          calculate otic days supply using bottle size, drops per mL, and dosing
          frequency.
        </p>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Step-by-step: how to calculate ofloxacin ear drops days supply
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Example ofloxacin ear drops days supply calculation
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Common ofloxacin ear drops days supply mistakes
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-cyan-100 bg-cyan-50 p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Frequently asked questions about ofloxacin ear drops days supply
        </h2>
