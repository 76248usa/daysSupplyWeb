...
export const metadata: Metadata = {
  title: "Latanoprost Days Supply Calculator | Pharmacist Guide",
  description:
    "Step-by-step pharmacist guide explaining how to calculate latanoprost days supply using bottle size, drops per mL, dosing frequency, and one-eye or both-eyes directions.",
  keywords: [
    "latanoprost days supply calculator",
    "latanoprost days supply",
    "latanoprost eye drop days supply",
    "how to calculate latanoprost days supply",
  ...
  openGraph: {
    title: "Latanoprost Days Supply Calculator | Pharmacist Guide",
    description:
      "Step-by-step pharmacist guide explaining how to calculate latanoprost days supply using bottle size, drops per mL, and dosing frequency.",
    url: "https://www.insulinprimingdayssupply.com/latanoprost-days-supply-calculator",
...
const faqs = [
  {
    question: "How do you calculate latanoprost days supply?",
    answer:
  ...
  },
  {
    ...
    answer:
      "A common pharmacy workflow estimate is 20 drops per mL, so a 2.5 mL bottle may be estimated at about 50 drops, although actual drop count can vary.",
  },
  {
    question: "Why can latanoprost days supply vary?",
    answer:
...
export default function LatanoprostDaysSupplyCalculatorPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": ["MedicalWebPage", "FAQPage"],
    name: "Latanoprost Days Supply Calculator",
    url: "https://www.insulinprimingdayssupply.com/latanoprost-days-supply-calculator",
    description:
      "Step-by-step guide for calculating latanoprost days supply using bottle size, drops per mL, dosing frequency, and one-eye or both-eyes directions.",
    audience: {
    ...
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-700">
          ...
          <strong>latanoprost days supply</strong> using bottle size, estimated
          drops per mL, dosing frequency, and one-eye or both-eyes directions.
        </p>

        <p className="mt-2 text-sm text-slate-600">
          This latanoprost days supply calculator helps pharmacists calculate
          eye drop days supply using bottle size, drops per mL, and dosing
          frequency.
        </p>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Step-by-step: how to calculate latanoprost days supply
        </h2>
        ...
        <div className="mt-6 space-y-6 text-slate-700">
          <div>
            ...
            <p className="mt-2 leading-7">
              Latanoprost is commonly dispensed in a 2.5 mL bottle, but the
              actual package dispensed should always be confirmed.
            </p>
          </div>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Example latanoprost days supply calculation
        </h2>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-slate-700">
              Common twice-daily ophthalmic workflow example.
            </p>
          </Link>
      ...
      <section className="mt-10 rounded-3xl border border-cyan-100 bg-cyan-50 p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Frequently asked questions about latanoprost days supply
        </h2>
