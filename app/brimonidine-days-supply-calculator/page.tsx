...
export const metadata: Metadata = {
  title: "Brimonidine Days Supply Calculator | Pharmacist Guide",
  description:
    "Step-by-step pharmacist guide explaining how to calculate brimonidine days supply using bottle size, drops per mL, dosing frequency, and one-eye or both-eyes directions.",
  keywords: [
    "brimonidine days supply calculator",
    "brimonidine days supply",
    "brimonidine eye drop days supply",
    "how to calculate brimonidine days supply",
  ...
  openGraph: {
    title: "Brimonidine Days Supply Calculator | Pharmacist Guide",
    description:
      "Step-by-step pharmacist guide explaining how to calculate brimonidine days supply using bottle size, drops per mL, and dosing frequency.",
    url: "https://www.insulinprimingdayssupply.com/brimonidine-days-supply-calculator",
...
const faqs = [
  {
    question: "How do you calculate brimonidine days supply?",
    answer:
  ...
  {
    question: "Why can brimonidine days supply vary?",
    answer:
...
export default function BrimonidineDaysSupplyCalculatorPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": ["MedicalWebPage", "FAQPage"],
    name: "Brimonidine Days Supply Calculator",
    url: "https://www.insulinprimingdayssupply.com/brimonidine-days-supply-calculator",
    description:
      "Step-by-step guide for calculating brimonidine days supply using bottle size, drops per mL, dosing frequency, and one-eye or both-eyes directions.",
    audience: {
    ...
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-700">
          ...
          <strong>brimonidine days supply</strong> using bottle size, estimated
          drops per mL, dosing frequency, and one-eye or both-eyes directions.
        </p>

        <p className="mt-2 text-sm text-slate-600">
          This brimonidine days supply calculator helps pharmacists calculate
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Step-by-step: how to calculate brimonidine days supply
        </h2>
        ...
        <div className="mt-6 space-y-6 text-slate-700">
          <div>
            ...
            <p className="mt-2 leading-7">
              Brimonidine is commonly dispensed in a 5 mL bottle, but the actual
          ...
          <div>
            ...
            <p className="mt-2 leading-7">
              ...
              medication is used in one eye or both eyes. Brimonidine is often
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Example brimonidine days supply calculation
        </h2>
      ...
      <section className="mt-10 rounded-3xl border border-cyan-100 bg-cyan-50 p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">
          Frequently asked questions about brimonidine days supply
        </h2>
